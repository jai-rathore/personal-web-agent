...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-b border-slate-200/60 z-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-14">
          ...
          >
            ...
            <span className="hidden sm:inline text-sm font-semibold tracking-tight">Jai's Agent</span>
          </button>
              ...
              <div className="flex items-center gap-2 ml-1 pl-2 border-l border-slate-200">
                {user ? (
                  <>
                    ...
                    {user.is_owner && (
                      <span className="hidden sm:inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-brand-50 text-brand-700 ring-1 ring-brand-200">
                        Owner
                      </span>
                    )}
                    <button
